    ...
    >
      <div className="max-w-3xl xl:max-w-4xl 2xl:max-w-5xl w-full text-center flex flex-col items-center">
        ...
        >
          {/* Rotating outer ring */}
            <motion.div
              className="w-32 h-32 sm:w-40 sm:h-40 md:w-52 md:h-52 lg:w-60 lg:h-60 xl:w-72 xl:h-72 mx-auto backdrop-blur-sm rounded-full flex items-center justify-center"
          ...
          >
            ...
            <motion.div
              className="w-24 h-24 sm:w-32 sm:h-32 md:w-44 md:h-44 lg:w-52 lg:h-52 xl:w-64 xl:h-64 rounded-full flex items-center justify-center shadow-xl"
        ...
        <motion.button
          ...
          className="w-full rounded-full py-3 sm:py-4 md:py-5 lg:py-6 xl:py-7 2xl:py-8 px-5 sm:px-6 md:px-8 lg:px-10 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold shadow-2xl flex items-center justify-center gap-3"
